...
MYSQL_USER = os.getenv("MYSQL_AUTH_USER")
MYSQL_PASSWORD = os.getenv("MYSQL_AUTH_PASSWORD")
MYSQL_HOST = os.getenv("MYSQL_AUTH_SERVICE_NAME")
MYSQL_PORT = os.getenv("MYSQL_AUTH_PORT")
MYSQL_DB = os.getenv("MYSQL_AUTH_DATABASE")
